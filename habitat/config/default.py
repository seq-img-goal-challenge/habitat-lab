...
# -----------------------------------------------------------------------------
_C.TASK.ENABLE_OBJECT_COLLISIONS = True
# -----------------------------------------------------------------------------
# SPAWNED OBJECTGOAL CATEGORY SENSOR
# -----------------------------------------------------------------------------
_C.TASK.SPAWNED_OBJECTGOAL_CATEGORY_SENSOR = CN()
_C.TASK.SPAWNED_OBJECTGOAL_CATEGORY_SENSOR.TYPE = "SpawnedObjectGoalCategorySensor"
# -----------------------------------------------------------------------------
# SPAWNED OBJECTGOAL APPEARANCE SENSOR
# -----------------------------------------------------------------------------
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR = CN()
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.TYPE = "SpawnedObjectGoalAppearanceSensor"
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.SENSOR_UUID = None
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.SENSOR_TYPE = "COLOR"
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.OUT_OF_CONTEXT = False
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.RANDOM_OBJECT_ROTATION = "DISABLE"
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.NUM_VIEWS = 6
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.VIEW_POINTS = CN()
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.VIEW_POINTS.NUM_ANGLES = 20
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.VIEW_POINTS.NUM_RADII = 10
...
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.TYPE = "SequentialTopDownMap"
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
_C.TASK.SEQUENTIAL_OBJECTGOAL_CATEGORY_SENSOR = (
    _C.TASK.SPAWNED_OBJECTGOAL_CATEGORY_SENSOR.clone()
)
_C.TASK.SEQUENTIAL_OBJECTGOAL_CATEGORY_SENSOR.TYPE = "SequentialObjectGoalCategorySensor"
_C.TASK.SEQUENTIAL_OBJECTGOAL_CATEGORY_SENSOR.PADDING_VALUE = -1
_C.TASK.SEQUENTIAL_OBJECTGOAL_CATEGORY_SENSOR.SEQUENTIAL_MODE = "FULL"
# -----------------------------------------------------------------------------
# SEQUENTIAL OBJECTGOAL APPEARANCE SENSOR
# -----------------------------------------------------------------------------
_C.TASK.SEQUENTIAL_OBJECTGOAL_APPEARANCE_SENSOR = (
    _C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE_SENSOR.clone()
)
_C.TASK.SEQUENTIAL_OBJECTGOAL_APPEARANCE_SENSOR.TYPE = "SequentialObjectGoalAppearanceSensor"
_C.TASK.SEQUENTIAL_OBJECTGOAL_APPEARANCE_SENSOR.PADDING_VALUE = 0
_C.TASK.SEQUENTIAL_OBJECTGOAL_APPEARANCE_SENSOR.SEQUENTIAL_MODE = "FULL"
# -----------------------------------------------------------------------------
