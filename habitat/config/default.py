...
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.SENSOR_UUID = None
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.SENSOR_TYPE = "COLOR"
...
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.VIEW_POINTS = CN()
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.VIEW_POINTS.NUM_ANGLES = 20
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.VIEW_POINTS.NUM_RADII = 10
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.VIEW_POINTS.MIN_RADIUS = 0.5
_C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.VIEW_POINTS.MAX_RADIUS = 3.5
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
_C.TASK.SEQUENTIAL_OBJECTGOAL_CATEGORY = _C.TASK.SPAWNED_OBJECTGOAL_CATEGORY.clone()
...
# -----------------------------------------------------------------------------
_C.TASK.SEQUENTIAL_OBJECTGOAL_APPEARANCE = _C.TASK.SPAWNED_OBJECTGOAL_APPEARANCE.clone()
