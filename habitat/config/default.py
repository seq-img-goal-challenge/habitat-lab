...
# -----------------------------------------------------------------------------
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP = CN()
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.TYPE = "SequentialTopDownMap"
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.MAX_EPISODE_STEPS = _C.ENVIRONMENT.MAX_EPISODE_STEPS
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.MAP_PADDING = 3
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.MAP_RESOLUTION = 1024
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.DRAW_SOURCE = True
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.DRAW_BORDER = True
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.DRAW_SHORTEST_PATH = True
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.DRAW_VIEW_POINTS = True
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.DRAW_GOAL_POSITIONS = True
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.DRAW_GOAL_AABBS = True
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.FOG_OF_WAR = CN()
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.FOG_OF_WAR.DRAW = True
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.FOG_OF_WAR.VISIBILITY_DIST =5.0
_C.TASK.SEQUENTIAL_TOP_DOWN_MAP.FOG_OF_WAR.FOV = 90
# -----------------------------------------------------------------------------
